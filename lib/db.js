...
export async function ensureDbSchema() {
  ...
  const alterQueries = [
    ...
    "ALTER TABLE notes ADD COLUMN is_trash INTEGER DEFAULT 0",
    "ALTER TABLE calendar_events ADD COLUMN start_time TEXT DEFAULT ''",
    "ALTER TABLE calendar_events ADD COLUMN end_time TEXT DEFAULT ''",
    "ALTER TABLE calendar_events ADD COLUMN category TEXT DEFAULT ''",
    "ALTER TABLE calendar_events ADD COLUMN created_at TEXT",
    "ALTER TABLE sleep_logs ADD COLUMN duration_hours REAL DEFAULT 0",
  ...
  const tableSchemas = [
    ...
    `CREATE TABLE IF NOT EXISTS chat_history (id TEXT PRIMARY KEY, user_id TEXT, sender TEXT, text TEXT, time TEXT, created_at TEXT)`
  ];
